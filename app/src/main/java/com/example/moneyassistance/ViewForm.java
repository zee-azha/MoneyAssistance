...
private DatePickerDialog datePickerDialog;
    ...
    public void onEditPressed() {
        ...
        builder.setMessage("Are you sure you want to change income data?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(getApplicationContext(), "The Income Data had changed", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(ViewForm.this,List_Income.class);
                startActivity(intent);
                finish();
            }
    ...
    public void onDelPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setCancelable(false);
        builder.setMessage("Are you sure you want to Delete income data?");
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                DbHelper.Delete_Income(Id);
                Intent intent = new Intent(ViewForm.this,List_Income.class);
                Toast.makeText(getApplicationContext(), "The Income Data had Delete", Toast.LENGTH_LONG).show();
                startActivity(intent);
                finish();
            }
        });
